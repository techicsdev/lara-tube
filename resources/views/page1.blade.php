...
@section('content')
    <div style="background-image:url('/images/Page-2-bg.jpg'); background-size:100% 100%;">
        ...
        <div class="min-height text-center">
            <span class="welcome-text1 mt-3">
                <div>
                    <p class="black content fadeInLeft animated">You can use display: flex to position an element to the bottom, but I do not think you want to use flex in this case, as it will affect all of your elements.</p>
                </div>
